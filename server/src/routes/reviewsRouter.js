...
reviewsRouter.get('/specialist/:specialistId', isIdValid('specialistId'), ReviewsController.getBySpecialist);
...
reviewsRouter.delete('/:id', isIdValid('id'), verifyAccessToken, ReviewsController.deleteReviewById);
